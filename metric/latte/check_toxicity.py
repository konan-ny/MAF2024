...
from MAF2024.metric.latte.get_bias_score import GetBiasScore
from MAF2024.metric.latte.get_llm_response import GetLLMResponse
...
class ScoringToxicity:
    ...
    def get_instruction(
        self, instruct_file_path: str = parent_dir + "/MAF2024/metric/latte/prompt.json"
    ):
