...
class CompasDataset(StandardDataset):
    def __init__(
        self,
        filepath=parent_dir + "/MAF2024/data/compas/compas-scores-two-years.csv",
...
class GermanDataset(StandardDataset):
    ...
    def __init__(
        self,
        filepath=parent_dir + "/MAF2024/data/german/german.data",
        label_name="credit",
        favorable_classes=[1],
...
class AdultDataset(StandardDataset):
    ...
    def __init__(
        self,
        file_directory=parent_dir + "/MAF2024/data/adult",
...
class PubFigDataset(StandardDataset):
    ROOT = parent_dir + "/MAF2024/data/pubfig/image"
    ATTRIBUTE_FILE = parent_dir + "/MAF2024/data/pubfig/pubfig_attributes.txt"
    URL_FILE = parent_dir + "/MAF2024/data/pubfig/dev_urls.txt"
    ...
    def download(self):
        ...
        merged.to_csv(
            parent_dir + "/MAF2024/data/pubfig/pubfig_attr_merged.csv",
            index=False,
            encoding="utf-8",
        )

    def to_dataset(self):
        img_files = glob.glob(parent_dir + "/MAF2024/data/pubfig/image/*")
        ...
        attribute = pd.read_csv(
            parent_dir + "/MAF2024/data/pubfig/pubfig_attr_merged.csv", encoding="utf-8"
        )
