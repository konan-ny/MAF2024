...
## Customized packages
from MAF2024.datamodule.concse.concse_dataset import LoadNLI, LoadSTSB
from MAF2024.datamodule.concse.concse_dataloader import (
    Iterator,
    CustomCollator,
    CustomDataLoader,
)
from MAF2024.loss.loss import TripletLoss
from MAF2024.utils.common import fix_seed
...
class Arguments:
    def __init__(self, model: str):
        ...
        self.ckpt_dir = parent_dir + "/MAF2024/model/"
...
def set_config(base_model: str):
    ...
    if base_model == "mbert_uncased" or base_model == "xlmr_base":
        with open(
            parent_dir + "/MAF2024/algorithms/config/concse/concse_base.json", "r"
        ) as f:
            train_config = json.load(f)
    elif base_model == "xlmr_large":
        with open(
            parent_dir + "/MAF2024/algorithms/config/concse/concse_large.json", "r"
        ) as f:
            train_config = json.load(f)
    return train_config
