...
from MAF2024.datamodule.intapt_datacollator import DataCollatorCTCWithPaddingCoraal
import MAF2024.algorithms.inprocessing.INTapt.util as util
...
class Arguments:
    def __init__(
        self,
        hf_cache_dir: str = os.environ["PYTHONPATH"] + "/MAF2024/data/INTapt/",
        batch_size: int = 2,
...
def get_args():
    ...
    parser.add_argument(
        "--hf_cache_dir",
        type=str,
        default=os.environ["PYTHONPATH"] + "/MAF2024/data/INTapt/",
    )
