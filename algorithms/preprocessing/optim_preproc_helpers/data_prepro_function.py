from MAF2024.datamodule.dataset import (
    AdultDataset,
    GermanDataset,
    CompasDataset,
    PubFigDataset,
...
def load_preproc_data_pubfig():
    ...
    if not os.path.isdir(os.environ["PYTHONPATH"] + "/MAF2024/data/pubfig"):
        pubfig.download()
...
def load_preproc_data_celeba():
    ...
    if not os.path.isdir(os.environ["PYTHONPATH"] + "/MAF2024/data/celeba"):
        celeba.download()
